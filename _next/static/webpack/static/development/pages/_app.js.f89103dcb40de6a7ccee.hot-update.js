...
})(["font-size:2.3em;font-weight:normal;position:relative;transition:all 0.1s;&::before{content:'';z-index:-1;position:absolute;bottom:-10px;left:0;background:#2d9cdb;width:100%;padding:5px 10px;transition:all 0.3s;transform:skewX(30deg);}&:hover{&::before{transform:skewX(-30deg);padding-top:17px;}}"]);
...
//# sourceMappingURL=_app.js.f89103dcb40de6a7ccee.hot-update.js.map