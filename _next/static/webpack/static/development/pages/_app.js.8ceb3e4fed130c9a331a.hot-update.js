...
})(["font-size:2.3em;font-weight:normal;position:relative;transition:all 0.1s;&::before{content:'';z-index:-1;position:absolute;bottom:-7px;left:0;background:#f2994a;width:80%;padding:5px 0;transition:all 0.2s;transition-timing-function:cubic-bezier();}&:hover{&::before{transform:translateY(calc(-100% - 5px));padding-top:14px;width:100%;}}"]);
...
//# sourceMappingURL=_app.js.8ceb3e4fed130c9a331a.hot-update.js.map