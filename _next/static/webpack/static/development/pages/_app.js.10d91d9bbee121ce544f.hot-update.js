...
})(["font-size:2.3em;font-weight:normal;position:relative;transition:all 0.1s;&::before{content:'';z-index:-1;position:absolute;bottom:-7px;left:0;background:#f2994a;width:80%;padding:5px 0;transition:all 0.4s cubic-bezier(0.68,-0.55,0.27,1.55);}&:hover{&::before{transform:translateY(calc(-100% - 5px)) translateX(-510%);padding-top:14px;width:120%;}}"]);
...
//# sourceMappingURL=_app.js.10d91d9bbee121ce544f.hot-update.js.map